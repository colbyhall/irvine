...
public:
	inline EntityRef(const World& world, EntityId entity)
		: m_world(&world), m_entity(entity) {}

	inline EntityRef(EntityRef&& move) noexcept
		: m_world(move.m_world), m_entity(move.m_entity) {}
...
public:
	inline EntityMut(World& world, EntityId entity)
		: m_world(&world), m_entity(entity) {}

	inline EntityMut(EntityMut&& move) noexcept
		: m_world(move.m_world), m_entity(move.m_entity) {}
